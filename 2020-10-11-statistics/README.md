...
![Untitled%201.png](images/2020-10-11-statistics/Untitled%201.png)

### 지시확률변수의 기대값

사건 A의 발생 여부에 종속하여 특정 값(1, 0)을 갖는 변수

![Untitled%202.png](images/2020-10-11-statistics//Untitled%202.png)

사건 A가 일어나면 1, 그 외에는 0

이 때, `지시확률변수`의 기대값은 사건 A가 일어날 확률과 같은데, 이를 근본적인 다리라고 한다.

![Untitled%203.png](images/2020-10-11-statistics/Untitled%203.png)
...
- **이산확률변수의 기대값을 이용**
    ...
    ![Untitled%204.png](images/2020-10-11-statistics/Untitled%204.png)
...
![Untitled%205.png](images/2020-10-11-statistics/Untitled%205.png)
